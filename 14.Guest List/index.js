...
let guest = ["Marium", "Amna", "Fatima", "Hina"];
//loop
//for each
//map
...
//map()
//invite guests
let invitation = guest.map(guestList => `Dear! ${guestList} Hope you're doing great ,you are invited for a dinner at my place , please come on time`);
