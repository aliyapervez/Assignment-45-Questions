...
function make_album(artist_name: string, album_title: string, num_tracks?: number): object {
    let album = {
        artist: artist_name,
        title: album_title,
    };
...
let album1 = make_album("Aliya", "Album title 1");
...
let album3 = make_album("Atif", "Album title 3", 10);
